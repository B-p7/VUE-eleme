<template>
  <div class="goods">
    ...
    <div class="foods-wrapper" ref="foods-wrapper">
      <ul>
        <li class="food-list food-list-hook" v-for="item in goods">
          ...
          <ul>
            <li @click="selectFood(food)" class="food-item border-1px" v-for="food in item.foods">
              <div class="icon">
    ...
    <food @cartadd="_drop" :food="selectedFood" ref="food"/>
  </div>
</template>
    ...
    computed: {
      currentIndex () {
        for (let i = 0; i < this.listHeight.length; i++) {
          ...
          if (!heightDown || (this.scrollY >= heightTop && this.scrollY < heightDown)) {
            return i
          }
        }
        return 0
